...
<body> 
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" id="myform" action="http://localhost:8080/WebsiteBanHang/XuLyDangNhap" method="post">
	...
	<%} %>
					...
					<div class="flex-c-m">
						<a href="#" class="login100-social-item bg1"  onclick="RequestLoginFB()" >
...
window.onclick = function(event) {
  ...
  function testAPI() {                      // Testing Graph API after login.  See statusChangeCallback() for when this call is made.
    ...
    function RequestLoginFB() {
        window.location = 'http://graph.facebook.com/oauth/authorize?client_id=2519608914934552&scope=public_profile,email,user_likes&redirect_uri=http://localhost:8080/WebsiteBanHang/index.jsp';
  }
