<%@page import="admin_dao.ProducerDAO"%>
					...
					<div class="col-lg-12">
						<div class="page-bar page-header">
							<ul class="page-breadcrumb">
								...
								<li><a href="producer.jsp">Nhà cung cấp</a></li>
							</ul>
						</div>
					</div>
					<!-- /.col-lg-12 -->
							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover"
										...
										<tbody>
											<%
												List<NhaCungCap>dsncc = ProducerDAO.findAll();
											%>
											<%
											...
											<tr class="odd gradeX">
												...
												<td><%=ncc.getDiaChi()%></td>
												<td class="center"><a href="<%=FullPath.fullPathAdmin("XuLySuaNhaCungCap?manhacungcap="+ncc.getMaNhaCungCap())+"&action=sua" %>"
													class="btn default btn-xs purple btn-edit"> <i
														class="fa fa-edit"></i> Sửa
												</a></td>
												<td class="center"><a href="<%=FullPath.fullPath("XuLyXoaNhaCungCap?manhacungcap="+ncc.getMaNhaCungCap()) %>"
